...
import {
  LexiconEditorComponent,
  LexiconEditorEntryController,
    ...
    ($stateProvider: angular.ui.IStateProvider) => {
      ...
      $stateProvider
        ...
        .state('editor.list', {
          ...
          templateUrl:
            '/angular-app/languageforge/lexicon/editor/editor-list.view.html',
        ...
        .state('editor.entry', {
          ...
          templateUrl:
            '/angular-app/languageforge/lexicon/editor/editor-entry.view.html',
