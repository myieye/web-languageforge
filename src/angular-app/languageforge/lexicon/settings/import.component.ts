...
export class LexiconImportController implements angular.IController {
  ...
  onFileSelect($file: File) {
    ...
    this.upload.isLift =
      LexiconImportController.fileExtension(this.upload.file.name) === 'lift';
  }
        ...
        (response: UploadResponse) => {
          ...
          if (isUploadSuccess) {
            ...
            const modalInstance = this.$modal.open({
              templateUrl:
                '/angular-app/languageforge/lexicon/settings/import-results.modal.html',
              controller: [
                '$scope',
                '$uibModalInstance',
                (
  ...
  private uploadSuccess = () => {
    ...
    this.sessionService.getSession(true).then(() => {
      this.notice.push(this.notice.SUCCESS, 'Import completed successfully');
      this.notice.push(
        this.notice.INFO,
        'Your project was successfully' +
...
export const LexiconImportComponent: angular.IComponentOptions = {
  ...
  templateUrl:
    '/angular-app/languageforge/lexicon/settings/import.component.html',
};
