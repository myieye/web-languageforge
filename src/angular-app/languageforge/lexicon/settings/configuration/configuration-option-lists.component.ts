      ...
      (newVal: LexOptionListItem[], oldVal: LexOptionListItem[]) => {
        if (newVal != null && newVal !== oldVal) {
          if (this.currentListIndex === this.oldListIndex) {
            this.olcOnUpdate({
              $event: { optionListsDirty: this.olcOptionListsDirty },
            });
          }
...
export const OptionListConfigurationComponent: angular.IComponentOptions = {
  ...
  templateUrl:
    '/angular-app/languageforge/lexicon/settings/configuration/configuration-option-lists.component.html',
};
