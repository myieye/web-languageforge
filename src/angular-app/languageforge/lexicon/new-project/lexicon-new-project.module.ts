...
import {
  LexiconNewProjectComponent,
  NewProjectAbstractState,
} from './lexicon-new-project.component';
import {
  NewProjectChooserComponent,
  NewProjectChooserState,
} from './new-project-chooser.component';
import {
  NewProjectInitialDataComponent,
  NewProjectInitialDataState,
} from './non-send-receive/new-project-initial-data.component';
import {
  NewProjectNameComponent,
  NewProjectNameState,
} from './non-send-receive/new-project-name.controller';
import {
  NewProjectSelectPrimaryLanguageComponent,
  NewProjectSelectPrimaryLanguageState,
} from './non-send-receive/new-project-select-primary-language.component';
import {
  NewProjectVerifyDataComponent,
  NewProjectVerifyDataState,
} from './non-send-receive/new-project-verify-data.component';
import {
  NewProjectSendReceiveCloneComponent,
  NewProjectSendReceiveCloneState,
} from './send-receive/new-project-clone.component';
import {
  NewProjectSendReceiveCredentialsComponent,
  NewProjectSendReceiveCredentialsState,
...
export const LexiconNewProjectModule = angular
  ...
  .component(
    'newProjectSendReceiveCredentials',
    NewProjectSendReceiveCredentialsComponent
  )
  ...
  .component(
    'newProjectSelectPrimaryLanguage',
    NewProjectSelectPrimaryLanguageComponent
  )
  .config([
    '$stateProvider',
    ...
    (
      ...
      $urlRouterProvider.when('', [
        '$state',
        ($state: angular.ui.IStateService | any) => {
