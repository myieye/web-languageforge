...
export interface ModalService extends angular.ui.bootstrap.IModalService {
  ...
  showModal(
    customModalDefaults: angular.ui.bootstrap.IModalSettings,
    customModalOptions: ModalOptions
  ): angular.IPromise<any>;
  showModalSimpleWithCustomTemplate(
...
export function ModalService($uibModal: angular.ui.bootstrap.IModalProvider) {
  ...
  this.showModalSimpleWithCustomTemplate =
    function showModalSimpleWithCustomTemplate(
      customTemplateUrl: string
    ): angular.IPromise<any> {
      const opts = {
        customTemplateUrl,
      ...
      return this.show(
        {
          templateUrl:
            '/angular-app/bellows/core/modal/modal-custom-template.html',
          backdrop: true,
        },
        opts
      );
