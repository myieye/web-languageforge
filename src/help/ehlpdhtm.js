...
var gbBsIE =
  gstrBsAgent.indexOf('msie') != -1 &&
  !gbBsOpera &&
  !gbBsKonqueror &&
  !gbBsSafari;
var gbBsNS =
  gstrBsAgent.indexOf('mozilla') != -1 &&
  gstrBsAgent.indexOf('spoofer') == -1 &&
  gstrBsAgent.indexOf('compatible') == -1 &&
  !gbBsOpera &&
  !gbBsKonqueror &&
  !gbBsSafari;
...
var gbBsWindows =
  gstrBsAgent.indexOf('win') != -1 || gstrBsAgent.indexOf('16bit') != -1;
...
var gbBsIE300301 =
  gbBsIE &&
  gnBsVer == 2 &&
  (gstrBsAgent.indexOf('3.00') != -1 ||
    gstrBsAgent.indexOf('3.0a') != -1 ||
    gstrBsAgent.indexOf('3.0b') != -1 ||
    gstrBsAgent.indexOf('3.01') != -1);
...
var gbInsideCHM =
  ...
  document.location.href.search(/chm/i) > 0;
...
if (gbBsIE) {
  if (parseInt(navigator.appVersion) >= 4) {
    ...
    if (gbBsIE4) {
      ...
      if (nVersion >= 5) gbBsIE5 = true;
      if (nVersion >= 5.5) {
        if (nVersion >= 7) gbBsIE7 = true;
        gbBsIE55 = true;
      }
    }
  }
...
if (gbBsNS6) {
  ...
  if (nPos != -1) {
    ...
    if (nPos2 != -1) {
      ...
      if (nVersion >= 20020823) gbBsNS7 = true;
    }
  }
}
if (gbBsOpera) {
...
function setAttribute(obj, attr, val) {
  if (gbBsIE) obj.setAttribute(attr, val);
  else {
    if (obj.setAttribute) obj.setAttribute(attr, val);
    else obj.setProperty(attr, val, null);
  }
}

function getAttribute(obj, attr) {
  if (gbBsIE) return obj.getAttribute(attr);
  else {
...
function BsscHasExtJs() {
  if (gbBsIE3Before || gbBsNS3Before) return false;
  return true;
}
  ...
  if (
    ...
    if (typeof objBody == 'object') {
      insertAdjacentHTML(
        objBody,
        'beforeEnd',
        '<OBJECT ID="HHComponentActivator" CLASSID="CLSID:399CB6C4-7312-11D2-B4D9-00105A0422DF" width=0 height=0></OBJECT>'
      );
      if (
        typeof HHComponentActivator != 'undefined' &&
        HHComponentActivator.object
      )
        HHComponentActivator.Activate(
          HH_ChmFilename,
          HH_WindowName,
          HH_GlossaryFont,
          HH_Glossary,
...
function BsHHActivXOnLoad() {
  if (gbBsIE4) BsHHActivateComponents();
}
...
function _WritePopupMenuLayer() {
  if (!g_bIsPopupMenuInit) {
    if (gbBsNS4 && !gbBsNS6) {
      ...
      document.write(
        "<DIV ID='PopupMenu' STYLE='position:absolute; left:0px; top:0px; z-index:4; visibility:hidden;'></DIV>"
      );
      if (!(gbBsNS4 && !gbBsNS6)) {
        document.write("<STYLE TYPE='text/css'>");
        if (gbBsMac && gbBsIE4) {
          document.write(
            ".PopupOver {font-family:'Arial'; color:white; background:navy; font-size:10pt; font-style:normal;font-weight:normal;text-decoration:none;}"
          );
          document.write(
            ".PopupNotOver {font-family:'Arial'; color:black; background:#c0c0c0; font-size:10pt; font-style:normal;font-weight:normal;text-decoration:none;}"
          );
        } else {
          document.write(
            ".PopupOver {font-family:'Arial'; color:white; background:navy; font-size:8pt; font-style:normal;font-weight:normal;text-decoration:none;}"
          );
          document.write(
            ".PopupNotOver {font-family:'Arial'; color:black; background:#c0c0c0; font-size:8pt; font-style:normal;font-weight:normal;text-decoration:none;}"
          );
        }
...
function _SeekFrameByName(cRoot, strName) {
  ...
  for (var i = 0; i < cRoot.frames.length; i++) {
    var cObj = null;
    if (!gbBsNS6) cObj = _SeekFrameByName(cRoot.frames(i).document, strName);
    else cObj = _SeekFrameByName(cRoot.frames[i], strName);
...
function _GetFrameByName(cRoot, strName) {
  ...
  if (cRoot.parent != cRoot) return _GetFrameByName(cRoot.parent, strName);
  else return null;
}
...
function GetXOffset(el) {
  ...
  while (
    el &&
    typeof el.offsetLeft != 'undefined' &&
...
function _PopupMenu_Invoke_2() {
  ...
  if (fn_arguments[1] == '') {
    ...
    } else targetDoc = window.document;
  } else {
  ...
  if (
    (!gbBsIE4 && !gbBsNS4 && !gbBsOpera7 && !gbBsKonqueror3 && !gbBsSafari) ||
    (gbBsMac && gbBsIE4 && window.event.srcElement.tagName == 'AREA')
  ) {
    var argLen = fn_arguments.length;
    ...
    var nWidth = 400;
    var strParam =
      'titlebar=no,toolbar=no,status=no,location=no,menubar=no,resizable=yes,scrollbars=auto';
    strParam += ',height=' + nHeight + ',width=200';
    strParam += ',resizable';

    var wndTemp = null;
    // Create a temporary window first to ensure the real popup comes up on top
    if (!gbBsOpera) wndTemp = window.open('', 'temp', strParam);

    // Create the real popup window
    var wndPopupLinks = null;
    if (gbBsOpera && gbBsMac) {
      wndTemp = window.open(document.location.href, 'temp', strParam);
      wndPopupLinks = window.open(
        document.location.href,
        'popuplinks',
        strParam
      );
    } else wndPopupLinks = window.open('', 'popuplinks', strParam);
    wndPopupLinks.document.open('text/html');

    // Close the temporary
    if (wndTemp) wndTemp.close();
  ...
  if (
    (argLen < 5 && (isNaN(fn_arguments[2]) || gbPopupMenuTopicList == null)) ||
  ...
  if (gbBsNS4 && !gbBsNS6) {
    strMenu =
      '<TABLE BORDER="1" CELLSPACING=0 CELLPADDING=3 BGCOLOR="#c0c0c0">';
  } else {
  ...
  while (i <= argLen - 1) {
    ...
    if (isNaN(fn_arguments[i]) || gbPopupMenuTopicList == null) {
      strMenu +=
        '<DIV class="PopupNotOver" STYLE="padding-left:3pt; padding-right:3pt;"><A HREF="' +
        fn_arguments[i + 1] +
        '"' +
        strTarget;
    } else {
      strMenu +=
        '<DIV class="PopupNotOver" STYLE="padding-left:3pt; padding-right:3pt;"><A HREF="' +
        gbPopupMenuTopicList[fn_arguments[i]].strURL +
        '"' +
        strTarget;
    }
    ...
    if (isNaN(fn_arguments[i]) || gbPopupMenuTopicList == null) {
      ...
      strMenu +=
        '<SPAN CLASS="PopupNotOver">' +
        gbPopupMenuTopicList[fn_arguments[i]].strTitle +
        '</SPAN>';
    }
  ...
  if (
    ...
    typeof window.event.clientX != 'undefined' &&
  ...
  if (gbBsIE4 || gbBsOpera7) {
    ...
    if (gbBsNS6 || gbChrome || gbSafari3) layerPopup.style.top = nEventY + 'px';
    else layerPopup.style.top = nEventY;
    if (gbBsNS6 || gbChrome || gbSafari3)
      layerPopup.style.left = nEventX + 'px';
    else layerPopup.style.left = nEventX;
...
function PopupMenu_Over(e) {
  if (gbBsIE4 || gbBsOpera7) e.srcElement.className = 'PopupOver';
  else if (gbBsNS6) e.target.parentNode.className = 'PopupOver';
  return;
}

function PopupMenu_Out(e) {
  if (gbBsIE4 || gbBsOpera7) e.srcElement.className = 'PopupNotOver';
  else if (gbBsNS6) e.target.parentNode.className = 'PopupNotOver';
  return;
}
function onPopupDivTouched(e) {
  if (typeof e != 'undefined' && e) e.stopPropagation();
}
...
function PopupMenu_HandleClick(e) {
  if (window.gbPopupMenuTimeoutExpired) {
    ...
    if (gOlddocumentClick) {
      if (gbBsNS4 && !gbBsNS6) document.onmousedown = gOlddocumentClick;
      else document.onclick = gOlddocumentClick;
    }
  }
  return;
}
    ...
    if (BSSCPopup_IsPopup()) {
      ...
      if (
        ...
        (el.href.indexOf('javascript:BSSCPopup') != -1 ||
          el.href.indexOf('javascript:null') != -1 ||
          el.href.indexOf('javascript:void(0)') != -1)
      ) {
...
function getIntervalID(nIndex) {
  if (nIndex == -1 || arrayIntervalId.length <= nIndex) return -1;
  else return arrayIntervalId[nIndex];
}
...
function getAbsPopupURL(nIndex) {
  ...
  else return arrayAbsPopupURL[nIndex];
}

function getPopupURL(nIndex) {
  if (nIndex == -1 || arrayPopupURL.length <= nIndex) return null;
  else return arrayPopupURL[nIndex];
}
...
function getPopupIFrame(nIndex) {
  if (gbAIR) {
    ...
    else return eval("document.frames['" + getPopupIFrameName(nIndex) + "']");
  }
}
...
function setDirty() {
  for (var i = 0; i < arrayPopupURL.length; i++) arrayDirty[i] = true;
}

function IsDirty(nIndex) {
  if (nIndex == -1) return true;
  else if (arrayDirty.length > nIndex) return arrayDirty[nIndex];
  else return true;
}
...
function hideAll() {
  for (var i = 0; i < arrayPopupURL.length; i++) {
    ...
    if (gbBsIE) removeThis(document.all(getPopupID(i)));
  }
  if (gbBsIE) arrayPopupURL.length = 0;
}
...
function setClear(nIndex) {
  if (nIndex != -1) arrayDirty[nIndex] = false;
}
...
function BSSCPopup_IsPopup() {
  if (DHTMLPopupSupport() && this.name.indexOf(gstrPopupIFrameName) != -1) {
    ...
    (gbBsNS4 || gbBsIE4 || gbBsOpera7) &&
    this.name.indexOf(gstrPopupID) != -1
  ) {
    return true;
  } else {
    return false;
...
function BsPopup_CreateDiv(nIndex) {
  if (!DHTMLPopupSupport()) return;
  // DO NOT SET Width and height for the div, otherwize it will make IE4 popup do not work when view the topic alone.
  var strPopupDiv =
    "<DIV ID='" +
    getPopupID(nIndex) +
    "' STYLE='position:absolute; top:-100; left:0; z-index:600; visibility:hidden;'>";
  strPopupDiv +=
    "<DIV ID='" +
    getPopupShadowID(nIndex) +
    '\' STYLE="position:absolute;top:0; left:0;  background-color:#C0C0C0;"></DIV>';
  strPopupDiv +=
    "<DIV ID='" +
    getPopupTopicID(nIndex) +
    '\' STYLE="position:absolute;top:0; left:0;  background-color:#FFFFFF;border:1px #000000 outset;">';
  strPopupDiv +=
    '<IFRAME title="Popup Window" ID=\'' +
    getPopupIFrameID(nIndex) +
    "' name='" +
    getPopupIFrameName(nIndex) +
    "' src = '" +
    getPopupURL(nIndex) +
  ...
  var objBody = getElementsByTag(document, 'BODY')[0];
  if (typeof objBody != 'object') return;
...
function BSSCPopup_PostWork(nIndex) {
  ...
  try {
    ...
    if (gbBsNS6)
      getPopupIFrame(nIndex).document.body.addEventListener(
        'click',
        BSSCPopupClicked,
        false
      );
    else getPopupIFrame(nIndex).document.body.onclick = BSSCPopupClicked;
  } catch (e) {}
  ...
  else document.onmousedown = BSSCPopupParentClicked;
}
...
function BSSCPopup_Timeout(nIndex, nToken) {
  ...
  if (
    gbBsNS6 ||
    (getPopupIFrame(nIndex).document.readyState == 'complete' &&
    ...
    for (var j = 0; j < colls.length; j++) {
      ...
      if (strtemp) {
        ...
        if (strtemp.indexOf('javascript:') == -1)
          if (colls[j].target == '') colls[j].target = '_parent';
      }
    }
  }
}
...
function _BSSCPopup(strURL, width, height) {
  ...
  if (DHTMLPopupSupport()) {
    if (!gbAIR && !gbInsideCHM) rhPopupEx.createPopup(strURL, width, height);
    else {
...
function window_BUnload() {
  gnBsUnload++;
  if (gnBsUnload > 1) return;
  for (var i = 0; i < arrayPopupURL.length; i++)
    removeThis(document.all(getPopupID(i)));
  arrayPopupURL.length = 0;
  if (ehlpdhtm_fOldBefureUnload) ehlpdhtm_fOldBefureUnload();
}
...
function _BSSCPopup2(strURL, width, height) {
  ...
  } else _BSSCPopup3(strURL, width, height);
}
...
function _BSSCPopup3(strURL, width, height) {
  if (window.name == gstrPopupSecondWindowName) {
    ...
    var strParam =
      'titlebar=no,toolbar=no,status=no,location=no,menubar=no,resizable=yes,scrollbars=yes';
    if (gbBsNS) {
      if (gbBsNS6) {
    ...
    if (gbBsSafari) {
      if (window.gPopupWindow) window.gPopupWindow.close();
      ...
      window.gPopupWindow = window.open(
        strURL,
        gstrPopupSecondWindowName,
        strParam
      );
      if (!gbBsIE) window.gPopupWindow.focus();

      if (wmTemp) wmTemp.close();
    }

    if (gbBsNS4) setEventHandle();
...
function NonIEPopup_HandleClick(e) {
  ...
  if (e.target.href) {
    if (e.target.href.indexOf('javascript:') == -1) {
      if (e.target.target == '') window.location.href = e.target.href;
      else window.open(e.target.href, e.target.target);
      this.close();
    }
  } else this.close();
  return false;
...
function BSSCPopup_AfterLoad(nIndex, nToken, cuswidth, cusheight) {
  ...
  if (gbSafari3 || gbAIR) {
    setAbsPopupURL(
      nIndex,
      window.getPopupIFrame(nIndex).document.location.href
    ); // change URL to abs url.
  ...
  if (
    window.getPopupIFrame(nIndex).document.readyState == 'complete' &&
    window.getPopupIFrame(nIndex).document.body != null
  ) {
    if (
      window
        .getPopupIFrame(nIndex)
...
function MoveDivAndShow(nIndex, nToken, cuswidth, cusheight) {
  ...
  if (isNaN(nLeft)) getPopupDivStyle(nIndex).left = nClickX + 'px';
  else getPopupDivStyle(nIndex).left = nLeft + 'px';

  if (isNaN(nTop)) getPopupDivStyle(nIndex).top = nClickY + 'px';
  else getPopupDivStyle(nIndex).top = nTop + 'px';
  ...
  if (gbChrome) {
    ...
    getElement(getPopupIFrameID(nIndex)).addEventListener(
      'load',
      handleLoadNS,
      false
    );
  else BSSCPopup_Timeout(nIndex, nToken);
  return;
}
...
function BSSCGetContentSize(thisWindow, size) {
  if (!gbBsIE4 && !gbBsOpera7 && !gbBsNS4 && !gbSafari3 && !gbAIR) return;
  ...
  if (!gbBsIE5 && !gbChrome && !gbAIR) thisWindow.moveTo(10000, 10000); // this is used to fix the flash on IE4.
  if (!gbAIR) {
    thisWindow.resizeTo(1, 1);
    thisWindow.resizeTo(
      maxgoldx,
      getScrollHeight(thisWindow) + getBscrollHeight()
    );
  }
  ...
  if (miny > GoldenSize.y) {
    // the popup does not fix in the parent wanted golden area. so try to expand itself as large as it can
    if (gbBsIE55) {
      thisWindow.resizeTo(
        maxx,
        getScrollHeight(thisWindow) + getBscrollHeight()
    ...
    if (miny > maxy) {
      // the popup must have a scroll, OK let it be.
      miny = maxy;
      size.x = maxx;
      size.y = maxy;
      thisWindow.document.body.scroll = 'yes'; // At this time we do want to show scroll any more. so it will looks better a little.
    } else {
      // popup still can fit in the parent area by someway. now we choose the same h/w rate as parent.
      size.y = miny;
      ...
      while (true) {
        x = x + deltax;
        if (!gbAIR) thisWindow.resizeTo(x, miny);
        diffy =
          getScrollHeight(thisWindow) + getBscrollHeight() - x * ClientRate;
        if (diffy > gBpermitYDelta)
          // it is higher than wanted, so x need to be wide a little bitter
          deltax = Math.abs(deltax) / 2;
        else if (diffy < -gBpermitYDelta)
          // it is shorter than wanted, so x need to be narrow a little bitter
          deltax = -Math.abs(deltax) / 2;
        // the y is close enough to wanted.
        else break;
        if (Math.abs(deltax) < gBpermitXDelta)
          // the next change is too slight and it can be ignore.
          break;
      }
    ...
    if (getScrollWidth(thisWindow) > maxgoldx) {
      ...
      while (true) {
        ...
        if (!gbAIR) thisWindow.resizeTo(x, miny);
        diffy =
          getScrollHeight(thisWindow) + getBscrollHeight() - x * getBRateH_W();
        if (diffy > gBpermitYDelta)
          // it is higher than wanted, so x need to be wide a little bitter
          deltax = Math.abs(deltax) / 2;
        else if (diffy < -gBpermitYDelta)
  ...
  if (gbBsNS6) size.y = size.y + 20;

  if (!gbAIR) thisWindow.resizeTo(size.x, size.y);
  return;
}

function getScrollWidth(thisWindow) {
  var w = thisWindow.document.body.scrollWidth
    ? thisWindow.document.body.scrollWidth
    : thisWindow.window.pageXOffset;
  return w ? w : 0;
}

function getScrollHeight(thisWindow) {
  var h = thisWindow.document.body.scrollHeight
    ? thisWindow.document.body.scrollHeight
    : thisWindow.window.pageYOffset;
  return h ? h : 0;
}
...
function isInsideHyperLink(obj) {
  if (obj && obj != getParentNode(obj)) {
    if (obj.tagName == 'A' || obj.tagName == 'IMG' || obj.tagName == 'VIDEO')
      return true;
    else return isInsideHyperLink(getParentNode(obj));
  } else return false;
}
...
function BSSCPopupClicked(e) {
  ...
  if (
    ...
    !gbAIR &&
    (gbBsNS6 || gbChrome) &&
    !(e != null && e.target != null && isInsideHyperLink(e.target))
  ) {
...
function BSSCHidePopupWindow() {
  if (window.gPopupWindow != null) {
    if (gbBsNS4) {
      if (
        typeof window.gPopupWindow != 'undefined' &&
  ...
  if (BsscHasExtJs()) {
    ...
    if (!gbBsNS3) {
      wndTemp = window.open(
        '',
        'temp',
        'titlebar=no,toolbar=no,status=no,location=no,menubar=no,resizable=yes,scrollbars=yes,height=3,width=4'
      );
    }
    // Create the real popup window
    var wndPopup = window.open(
      strURL,
      'BSSCPopup',
...
function PopupMenu_Invoke() {
  if (
    typeof wfRelatedTopic == 'function' &&
    typeof IsFlashSupported == 'function'
  ) {
...
function Wait_PopupMenuReady() {
  ...
  } else setTimeout('Wait_PopupMenuReady()', 100);
}
...
function PopupMenu_InvokeReady() {
  if (gbWndPopupLinks != null) {
    ...
    if (gbBsNS2) {
      ...
      gbWndPopupLinks.document.write(
        'function gotoUrl(aUrl) {opener.window.location=aUrl; close();}'
      );
      gbWndPopupLinks.document.write('<');
      gbWndPopupLinks.document.write('/script>');
    }
...
function InitEachChild(el) {
  for (var i = 0; i < getChildNodes(el).length; i++) {
    ...
    if (child.tagName == 'SCRIPT' || child.tagName == '!') continue;
    ...
    if (child.id != '') {
      ...
      if (href != null && href > '' && href.indexOf('BSSCPopup') >= 0)
        ...
        child.className == 'dropspot' ||
        child.className == 'expandspot' ||
...
function RetrieveTextInner(el) {
  var x = '';
  if (!el || el.tagName == '!' || el.tagName == 'SCRIPT') return x;

  if (IsParagraph(el)) {
    var strNewID = ' ';
    if (el.id != '') strNewID += 'id=' + el.id + '_NewSpan ';
    x =
      '<span' +
      strNewID +
      "style='" +
...
function RetrieveCleanHTML(strRawHTML, strTagOpen, strTagClose, nDistance) {
  ...
  if (nTagOpen < 0) return strRawHTML;

  var nTagClose = strRawHTML.indexOf(strTagClose, nTagOpen);
  if (nTagClose < nTagOpen) return strRawHTML;

  if (typeof nDistance == 'number' && nDistance > 0)
    if (nTagClose - nTagOpen != nDistance) return strRawHTML;

  var strCleanOnce =
    strRawHTML.substring(0, nTagOpen) +
    strRawHTML.substr(nTagClose + strTagClose.length);
  return RetrieveCleanHTML(strCleanOnce, strTagOpen, strTagClose);
}

function kadovRetrieveCleanHTML(
  strRawHTML,
  strTagOpen,
  strTagClose,
  nDistance
...
function AdjustObjectTag(strRawHTML, nStartPos) {
  ...
  if (nDTCTagOpen < 0) return strRawHTML;
  var nDTCTagClose = strRawHTML.indexOf(strDTCTagClose, nDTCTagOpen);
  if (nDTCTagClose < nDTCTagOpen) return strRawHTML; // no Design Time Controls;

  //Is the DTC HTML Help Control?
  var strRTObjTagOpen = 'classid=clsid:ADB880A6-D8FF-11CF-9377-00AA003B7A11';
  var strRTObjTagClose = '</OBJECT>';
  var nRTObjTagOpen = strRawHTML.indexOf(strRTObjTagOpen, nDTCTagOpen);
  if (nRTObjTagOpen < nDTCTagOpen) return strRawHTML;
  var nRTObjTagClose = strRawHTML.indexOf(strRTObjTagClose, nRTObjTagOpen);
  if (nRTObjTagClose < nRTObjTagOpen) return strRawHTML; // is not a HTML help control

  // Is it a related Topics html help control?
  var strRTObjLabel = '<PARAM NAME="Command" VALUE="Related Topics';
  if (strRawHTML.indexOf(strRTObjLabel, nRTObjTagOpen) < 0) return strRawHTML;
  ...
  if (nRTItemsOpen < nDTCTagOpen) return strRawHTML;
  var nRTItemsClose = strRawHTML.indexOf(strRTItemsClose, nRTItemsOpen);
  if (nRTItemsClose == -1)
    nRTItemsClose = strRawHTML.indexOf(strRTItemsClose2, nRTItemsOpen);
  if (nRTItemsClose < nRTItemsOpen) return strRawHTML;

  // found a items string
  var strItems = strRawHTML.substring(
    nRTItemsOpen + strRTItemsOpen.length,
    nRTItemsClose
  );
  if (strItems.length < 1) return strRawHTML;

  // to reconstruct the item(s) param tag(s)
  var strItemsArray = strItems.split('$$**$$');
  if (strItemsArray.length < 1) return strRawHTML;
  ...
  var strAdjustedHTML =
    strRawHTML.substring(0, nRTObjTagClose) +
    strRunTimeItemParam +
    strRawHTML.substring(nRTObjTagClose, strRawHTML.length);
...
function TextPopupOnLoad(el) {
  ...
  var name = src;
  if (src.substr(0, 1) == '#') name = src.substr(1, src.length - 1);
...
function getElementsByTag(obj, sTagName) {
  if (obj.getElementsByTagName) return obj.getElementsByTagName(sTagName);
  else if (obj.all) return obj.all.tags(sTagName);
  return null;
}
...
function getParentNode(obj) {
  ...
  else if (obj.parentElement) return obj.parentElement;
  return null;
}
...
function getChildNodes(obj) {
  if (obj.childNodes) {
    ...
    return children;
  } else if (obj.children) return obj.children;
  return null;
}
...
function TextPopup(el) {
  ...
  for (var i = 0; i < getChildNodes(el).length; i++) {
    ...
    if (child && child.tagName == 'IMG') {
      if (child.className == 'Twisties') {
        ...
        else if (child.style) child.style.display = '';
      }
    }
  ...
  if (srcDiv) {
    if (srcDiv.style.display == '') srcDiv.style.display = 'none';
    else {
      if (srcDiv.className == 'expandtext') {
        var inner = RetrieveTextInner(srcDiv);
        if (inner == '') inner = srcDiv.innerHTML;
        if (
          inner.indexOf('&nbsp;') != 0 &&
          inner.indexOf(' ') != 0 &&
          inner.indexOf('&#160;')
  ...
  if (gbBsIE4) event.returnValue = false;
  return;
}
...
function FindParentParagraph(el) {
  ...
  if (IsParagraph(getParentNode(el))) return getParentNode(el);
  else return FindParentParagraph(getParentNode(el));
}
...
function InitTriggersInHead() {
  if (Object.xDelayedInitElements) {
    ...
    for (i = 0; i < x.length; i++) InitTrigger(x[i]);
  }
}
...
function InitTrigger(element, a_targets) {
  ...
  var targets = null;
  if (typeof a_targets != 'undefined') targets = a_targets;
  if (!targets) targets = getAttribute(srcElement, 'x-targets');
  if (!targets) targets = getAttribute(srcElement.style, 'x-targets');
  if (!targets) return;
...
function IsParentVisible(el) {
  ...
  if (el.style.display == 'none')
    ...
    return false;
  else return IsParentVisible(getParentNode(el));
}
...
function InitEffects(element, effectsList) {
  ...
  if (effectsList) {
    ...
    while (nStart >= 0 && indx > 0 && indx < str.length) {
      ...
      if (indx2 == -1) indx2 = str.length;
      value = effectsList.substr(indx + 1, indx2);
      if (effect && value) setAttribute(srcElement, effect, value);
...
function InitEffect(element, prop) {
  var values = null;
  if (getAttribute(element, prop)) values = getAttribute(element, prop);
  else if (
    getAttribute(element, 'currentStyle') &&
  ...
  for (var i = 0; i < functions.length; i++) {
    ...
    for (var j = 0; j < arrForClickCount.length; j++) {
      ...
      if (nPageClick >= 0) {
        ...
        if (nPageClick > 0) {
          nClickTimes =
            arrForClickCount[j].substring(
              nPageClick + 1,
              arrForClickCount[j].length
            ) * 1;
          break;
        }
      }
    ...
    if (j < arrForClickCount.length) {
      ...
      for (var k = 0; k < arrForClickCount.length; k++) {
        if (k != j) {
          ...
          if (k < arrForClickCount.length - 1) args += ',';
        }
      }
    }
...
function bsscFXInit(
  ...
  if (typeof event_type == 'string') event_type = event_type.toLowerCase();
  if (typeof action_type == 'string') action_type = action_type.toLowerCase();
...
CCSSP.GetObject = function (obj) {
  ...
  if (typeof obj == 'object') return obj;
    ...
    if (gbBsNS6) return getElement(obj);
    else if (gbBsNS4) return eval('document.' + obj);
...
CCSSP.MoveObjectTo = function (obj, x, y) {
  ...
  if (gbBsNS4 && !gbBsNS6) obj.moveTo(x, y);
  else {
    if (x == '') x = 0;
    if (y == '') y = 0;
...
CCSSP.MoveObjectBy = function (obj, dx, dy) {
  ...
  } else if (gbBsNS4) obj.moveBy(dx, dy);
  else {
...
CCSSP.SetObjectBGColor = function (obj, color) {
  ...
  if (gbBsNS6) obj.style.setProperty('background-color', color, 0);
  else if (gbBsNS4) obj.bgColor = color;
...
CCSSP.ShowObject = function (obj, bShow) {
  ...
  if (gbBsNS6)
    obj.style.setProperty(
      'visibility',
      bShow == true ? 'visible' : 'hidden',
      null
    );
  else if (gbBsNS4) obj.visibility = bShow == true ? 'show' : 'hide';
  else obj.style.visibility = bShow == true ? 'visible' : 'hidden'; // when hidden, it still occupy some space.
};

CCSSP.GetObjectLeft = function (obj) {
  // retrieve the x coordinate of a posionable object
  if (gbBsNS6) return obj.style.left;
  else if (gbBsNS4) return obj.left;
  else return obj.style.pixelLeft;
};

CCSSP.GetObjectTop = function (obj) {
  // retrieve the y coordinate of a posionable object
  if (gbBsNS6) return obj.style.top;
  else if (gbBsNS4) return obj.top;
  else return obj.style.pixelTop;
};

CCSSP.GetObjectContainLeft = function (obj) {
  // retrieve the x coordinate of a posionable object relative to it's parent element
  if (typeof obj.pageX != 'undefined') return obj.pageX;
  else if (typeof obj.clientLeft != 'undefined') return obj.clientLeft;
  else return obj.offsetLeft;
};

CCSSP.GetObjectWindowLeft = function (obj) {
  // retrieve the x coordinate of a posionable object relative to browser window
  if (gbBsNS4 && !gbBsNS6) return obj.pageX;
  else {
...
CCSSP.GetObjectContainTop = function (obj) {
  ...
  if (typeof obj.pageY != 'undefined') return obj.pageY;
...
CCSSP.GetObjectWindowTop = function (obj) {
  ...
  if (gbBsNS4 && !gbBsNS6) return obj.pageY;
  else {
...
CCSSP.GetObjectHeight = function (obj) {
  ...
  if (gbBsNS4 && !gbBsNS6) return obj.clip.height;
  else return obj.offsetHeight;
};

CCSSP.GetObjectWidth = function (obj) {
  // retrieve the width of a posionable object
  if (gbBsNS4 && !gbBsNS6) return obj.clip.width;
...
CCSSP.RegisterEventHandler = function (srcObj, rawEventName, funcHandler) {
  ...
  if (srcObj == window && rawEventName == 'onload') {
    ...
    if (window.addEventListener) {
      window.addEventListener(
        'load',
        new Function('event', funcHandler),
        false
      );
      bSet = true;
  ...
  if (gbBsMac && gbBsIE4 && !gbBsIE5) {
    if (typeof srcObj[rawEventName.toLowerCase()] == 'unknown') {
      ...
      for (var i = 0; i < document.scripts.length; i++) {
        ...
        if (
          (script.htmlFor == srcObj.id || script.htmlFor == srcObj) &&
          script.event == rawEventName
        ) {
    ...
    if (oldInlineHandler != null && typeof oldInlineHandler != 'undefined') {
      ...
      if (bodyStart > 0 || bodyEnd > bodyStart)
        oldHandler = functionDefinition.substr(
          bodyStart + 1,
          bodyEnd - bodyStart - 2
        );
    } else if (gbBsIE4) {
  ...
  if (oldHandler.indexOf(funcHandler) >= 0) return; // to prevent register the funtion twice.

  if (gbBsNS4) {
    // only "onload, onresize, onfocus" apply to window
    // other raw events will apply to layer
    var noOn = rawEventName.substring(2, rawEventName.length);
    if (typeof noOn == 'string' && noOn.length > 3) {
      if (srcObj.captureEvents) srcObj.captureEvents(Event[noOn.toUpperCase()]);
    }
  }

  var newHandler = oldHandler;
  if (newHandler.length == 0) newHandler = funcHandler;
  else newHandler += '; ' + funcHandler;
  if (gbBsNS6 && srcObj.addEventListener)
    srcObj.addEventListener(
      noOn.toLowerCase(),
      new Function('event', newHandler),
      false
    );
  else srcObj[rawEventName.toLowerCase()] = new Function(newHandler);
};

CCSSP.GetWindowHeight = function () {
  // retrieve the height of available content in browser window
  if (gbBsNS4) return window.innerHeight;
  else return document.body.clientHeight;
};

CCSSP.GetWindowBottom = function () {
  // retrieve the bottom postion of browser window
  if (gbBsNS4) return window.outerHeight + window.pageYOffset;
  else return document.body.clientHeight + getScrollTop();
};

CCSSP.GetWindowWidth = function () {
  // retrieve the width of available content in browser window
  if (gbBsNS4) return window.innerWidth;
  else return document.body.clientWidth;
};

CCSSP.GetWindowRight = function () {
  // retrieve the right postion of browser window
  if (gbBsNS4) return window.outerWidth + window.pageXOffset;
  else return document.body.clientWidth + getScrollLeft();
};

CCSSP.TrimString = function (objString, subtrim) {
  // to trim the "subtrim" in the beginning and ending of a string object
  if (typeof subtrim != 'string' || subtrim == null) return objString;
  var strHead = objString.substring(0, 1);
  var strRear = objString.substring(objString.length - 1, objString.length);
  if (strHead != subtrim && strRear != subtrim) return objString;

  var spacePos = objString.indexOf(subtrim);
  if (spacePos < 0) return objString;
...
CCSSP.TrimSpace = function (objString) {
  ...
  if (typeof Trim1 != 'string' || Trim1 == null) return Trim1;
  var strHead = Trim1.substring(0, 1);
  if (strHead == '"') return CCSSP.TrimString(Trim1, '"');
  return CCSSP.TrimString(Trim1, "'");
};

CCSSP.GetEventElement = function (navEventObject) {
  // to get the element who fired the current event
  if (gbBsNS4) return navEventObject.target;
...
CCSSP.PrepareFilter = function (Obj) {
  ...
  if (gbBsIE7) {
    if (Obj.style.zoom != '') return;
    Obj.style.zoom = 1;
  } else {
    if (Obj.style.width != '' || Obj.style.height != '') return;
    Obj.style.height = CCSSP.GetObjectHeight(Obj);
  }
};

CCSSP.IsDescendant = function (progenitor, progeny) {
  if (typeof progeny == 'undefined' || progeny == null) return false;
  else if (progeny == progenitor) return true;
  else if (progeny.id == progenitor.id) return true;
  else if (getParentNode(progeny) == getParentNode(progenitor)) return false;
  else return CCSSP.IsDescendant(progenitor, getParentNode(progeny));
};

CCSSP.IsTextTag = function (Obj) {
  if (typeof Obj.tagName == 'undefined') return false;
  return (
    Obj.tagName.indexOf('H') == 0 ||
    Obj.tagName == 'P' ||
    Obj.tagName == 'FONT' ||
    Obj.tagName == 'SPAN'
  );
...
function CTrigger(TriggerElement) {
  ...
  if (
    this.eleTrigger.tagName == 'AREA' &&
    getAttribute(this.eleTrigger, 'href') == ''
  )
...
CTrigger.prototype.AddTargetID = function (strTargetID) {
  ...
  if (typeof strTargetID != 'string') return;
...
CTrigger.prototype.OnTriggerClick = function (event) {
  ...
  var strEventType = this.nCounter++ % 2 == 0 ? 'bssctrigger1' : 'bssctrigger2';
...
CTarget.prototype.SetEventManager = function (
  ...
  if (eventAgency != null) {
    ...
    if (one_event_type == 'bsscpageclick') {
      ...
      else this.objManager[one_event_type][ct].nPageClick = 1;

      if (
        typeof this.objManager.nMinPageClickIndex == 'undefined' ||
        this.objManager[one_event_type][ct].nPageClick <
          this.objManager[one_event_type][this.objManager.nMinPageClickIndex]
            .nPageClick
      )
    ...
    if (one_event_type == 'bssctrigger1' || one_event_type == 'bssctrigger2')
      if (typeof this.strTriggerEvent == 'undefined')
        this.strTriggerEvent =
          one_event_type == 'bssctrigger1' ? 'bssctrigger2' : 'bssctrigger1';
...
CTarget.prototype.OnEvent = function (strBsscEvent, event) {
  ...
  if (typeof this.objManager[strBsscEvent] == 'object') {
    ...
    for (var i = 0; i < eventAgency.length; i++) {
      if (
        strBsscEvent == 'bsscpageclick' &&
        eventAgency[i].nPageClick != CTarget.nPageClickCounter
      )
        continue;
      else if (strBsscEvent == 'bsschover' && event.type == 'mouseout')
        eventAgency[i].EndEffect();
      // to invoke the unified function in effect object
      else eventAgency[i].UpdateEffect();
    }
  }
};

CTarget.prototype.SetState = function (strBsscEvent) {
  if (typeof this.objManager[strBsscEvent] != 'object') return false;
  ...
  if (strBsscEvent == 'bsscpageclick') {
    ...
    for (var i = 0; i < eventAgency.length; i++) eventAgency[i].PrepareEffect(); // to invoke the unified function in effect object
    if (i > 0) return true;
    else return false;
  }
};
  ...
  if (typeof CEngine.objTarget[strTargetID] == 'object') {
    if (strBsscEvent == 'bssctrigger1' || strBsscEvent == 'bssctrigger2') {
      ...
      if (strBsscEvent == CEngine.objTarget[strTargetID].strTriggerEvent)
        strBsscEvent =
          strBsscEvent == 'bssctrigger1' ? 'bssctrigger2' : 'bssctrigger1';
...
CEngine.AdjustPageClickCounter = function () {
  ...
  for (var strTargetID in CEngine.objTarget) {
    //to enumerate all target
    // try to find the minum pageCliclConter greater than CTarget.nPageClickCounter
    var objEventPageClick =
      CEngine.objTarget[strTargetID].objManager.bsscpageclick;
    if (objEventPageClick != null) {
      for (var i = 0; i < objEventPageClick.length; i++) {
        var nOtherPageClick = objEventPageClick[i].nPageClick;
        if (nOtherPageClick == CTarget.nPageClickCounter) return;
...
CEngine.OnPageClick = function (event) {
  ...
  if (objClickedTrigger != null)
    // the clicked trigger found
    objClickedTrigger.OnTriggerClick(event);
  // no trigger is clicked
  else {
...
CEngine.BuildTargetObject = function (
  ...
  if (typeof CEngine.objTarget[target_ID] != 'object') return false; // the engine's AddOneTarget function might have failed.
  ...
  if (typeof action_setting == 'string') arrSetting = action_setting.split('|'); // to split the combined action_setting string
  // to calibrate the arrays
  for (var i = arrSetting.length; i < arrAction.length; i++) {
    if (typeof arrSetting[i] != 'string') arrSetting[i] = '';
  }
  ...
  if (arrEvent.length > 1) {
    ...
    if (arrAction.length != 2) return false; // if event is combined, there must be 2 actions
    for (i = 0; i < 2; i++) {
      if (
        TargetObject.SetEventManager(
          arrEvent[i],
          arrAction[i],
          arrSetting[i],
          event_additional
  ...
  } // the event_type string is not combined
  else {
    for (i = 0; i < arrAction.length; i++) {
      ...
      if (
        typeof TargetObject.objManager[event_type] != 'object' ||
...
CEngine.BuildTriggerObject = function (trigger_ID, target_ID) {
  ...
  for (var i = 0; i < arrTrigger.length; i++) {
    ...
    if (eleTrigger == null) continue; // the trigger_ID string in the HTML code maybe wrong
    CEngine.AddOneTrigger(arrTrigger[i], eleTrigger);

    // to get the target object
    if (typeof this.objTrigger[arrTrigger[i]] != 'object') continue; // the engine's AddOneTarget function might have failed.
...
CAgencyFly.prototype.UpdateEffect = function () {
  if (this.timer == null) this.ResetParameters();

  var percent = (new Date().getTime() - this.startTime) / this.duration;
  if (percent >= 1.0) this.EndEffect();
  else {
...
CAgencyFly.prototype.EndEffect = function () {
  ...
  // FlyOut
  else CCSSP.MoveObjectTo(this.ele, this.startX, this.startY);
  CCSSP.ShowObject(this.ele, this.bIsIn);
};
  ...
  if (this.bIsIn) {
    ...
    switch (this.direction) {
      ...
      case 'upleft':
        ...
        break;
      case 'downleft':
        this.startX = -(offsetBottom < offsetRight
          ? offsetBottom
          : offsetRight);
        this.startY = -this.startX;
        break;
    ...
    switch (this.direction) {
      ...
      case 'upleft':
        ...
        break;
      case 'downleft':
        this.finalX = -(offsetBottom < offsetRight
          ? offsetBottom
          : offsetRight);
        this.finalY = -this.finalX;
        break;
...
CAgencyElastic.prototype.UpdateEffect = function () {
  ...
  if (percent >= 1.0) this.EndEffect();
    ...
    var rx =
      Math.abs(this.startX) > Math.abs(this.startY) ? this.startX : this.startY;
    switch (this.direction) {
      case 'left':
      case 'right':
...
CAgencyZoom.prototype.UpdateEffect = function () {
  ...
  if (percent >= 1.0) this.EndEffect();
    ...
    var arr;
    if (this.ele.all) arr = this.ele.all;
    else arr = this.ele.getElementsByTagName('*');
...
CAgencyZoom.prototype.UpdateEffectAllChildren = function (
  child,
  FontSize,
  Factor
) {
  if (CCSSP.IsTextTag(child)) child.style.fontSize = FontSize;
  else {
...
CAgencyZoom.prototype.EndEffectAllChildren = function (child) {
  if (CCSSP.IsTextTag(child)) child.style.fontSize = child.orgFontSize;
  else {
...
CAgencyZoom.prototype.ResetParametersAllChildren = function (child) {
  ...
  if (CCSSP.IsTextTag(child)) child.orgFontSize = child.style.fontSize;
  else {
    if (child.width > '' || child.height > '') {
      child.orgWidth = child.intactWidth = child.width;
      child.orgHeight = child.intactHeight = child.height;
    } else if (
      typeof child.orgWidth != 'number' &&
      typeof child.orgHeight != 'number'
    ) {
...
CAgencyAlpha.prototype.UpdateEffect = function () {
  ...
  if (percent >= 1.0) this.EndEffect();
    ...
    this.ele.filters.alpha.opacity =
      this.startOpacity * (1.0 - percent) + this.endOpacity * percent;
    CCSSP.SetTimer(this, 20);
  }
};
...
CAgencyWave.prototype.UpdateEffect = function () {
  ...
  if (this.timer == null) this.ResetParameters();
  if (
    typeof this.ele.filters == 'undefined' ||
    typeof this.ele.filters.wave != 'object'
  ) {
    this.EndEffect();
    return;
  }
...
CAgencyRevealTrans.prototype.UpdateEffect = function () {
  ...
  } else CCSSP.ShowObject(this.ele, true);
};
...
CAgencyBlur.prototype.UpdateEffect = function () {
  ...
  CCSSP.PrepareFilter(this.ele);
  this.ele.style.filter =
    'blur(strength=' + this.strength + ', direction=' + this.direction + ')';
};
...
CCSSP.RegisterEventHandler(
  window,
  'onload',
  'CEngine.OnPageLoad(event);BSSCOnLoad(event);InitTriggersInHead(event);'
);
CCSSP.RegisterEventHandler(
  document,
  'onclick',
  'CEngine.OnPageClick(event);BSSCOnClick(event);'
);
CCSSP.RegisterEventHandler(
  document,
  'onmouseover',
  'CEngine.OnMouseOver(event);BSSCOnMouseOver(event);'
);
CCSSP.RegisterEventHandler(
  document,
  'onmouseout',
  'CEngine.OnMouseOver(event);BSSCOnMouseOut(event);'
);
    ...
    case 'sendContentSize':
      {
        ...
        if (
          typeof rhPopupEx.gLastGoodHeight == 'undefined' ||
...
function onPopupClicked(e) {
  ...
  if (!e) e = popupIFrame.contentWindow.event;
  if (e) {
    if (e.target) target = e.target;
    else target = e.srcElement;
  }
  if (!gbAIR) {
    if (target && isInsideHyperLink(target)) return;
  }
  if (window.removeEventListener)
...
function RHPopupEx() {
  ...
  this.createPopup = function (strURL, width, height) {
    ...
    if (typeof strURL == 'undefined' || strURL == '') return false;
  ...
  this.createPopupContainer = function () {
    ...
    strPopupDiv +=
      "<div id='" +
      this.strPopupShadowID +
      '\' style="position:absolute;top:0; left:0; background-color:#C0C0C0;"></div>';
    strPopupDiv +=
      "<div id='" +
      this.strPopupTopicID +
      '\' style="position:absolute;top:0; left:0;  background-color:#FFFFFF;border:1px #000000 outset;';
  ...
  this.canDoBetter = function () {
    if (this.width < this.gWidth /*&& this.height > this.gHeight*/) return true;
  };
  ...
  this.computePopupWndSize = function () {
      ...
      try {
        ...
        while (this.canDoBetter()) {
          ...
          if (this.height < lastHeight) {
            //may be there is no reflow content to reduce height on increasing width
    ...
    } else requestContentSize(this.getPopupIFrame().contentWindow);
  };
  ...
  this.resizeMoveAndShowPopup = function () {
    ...
    if (this.strBookmark != '') {
      ...
      this.getPopupIFrame().contentWindow.location.href =
        this.strPopupURL + this.strBookmark;
    }

    try {
      BSSCPopup_ChangeTargettoParent(
        this.getPopupIFrame().contentWindow.document
      );
    } catch (e) {
  ...
  this.postWork = function () {
    try {
      if (gbBsIsMobile == false) {
        if (window.addEventListener) {
          this.getPopupIFrame().contentWindow.addEventListener(
            'click',
            onPopupClicked,
            false
          );
        } else if (window.document.attachEvent) {
          this.getPopupIFrame().contentWindow.document.attachEvent(
            'onclick',
            onPopupClicked
          );
        }
  ...
  this.OnLoadRHPopup = function () {
    ...
    if (
      ...
      rhPopupEx
        .getPopupIFrame()
        .contentWindow.document.location.href.indexOf('about:blank') != -1
    ) {
      rhPopupEx.getPopupIFrame().contentWindow.document.location.href =
        rhPopupEx.strPopupURL;
      return;
    }
    ...
    } else rhPopupEx.resizeMoveAndShowPopup();
  };
}
...
function supports_mp4_video() {
  ...
  //alert(playType);
  if (playType == '' || playType == 'no') return false;
  else return true;
}

function getUrlParam(paramName, url) {
  if (url == null || url == 'undefined') url = document.location.href;
...
function send_flv_command(strMultimediaFlvName, strMultimediaFlvCommand) {
  try {
    if (
      strMultimediaFlvName != null &&
      typeof strMultimediaFlvName != undefined
    ) {
      ...
      if (flashMediaPlayer != null && typeof flashMediaPlayer != undefined) {
        if (
          strMultimediaFlvCommand != null &&
          typeof strMultimediaFlvCommand != undefined
        ) {
          flashMediaPlayer.TakeMultimediaAction(
            strMultimediaFlvCommand.replace('%20', ' ')
          );
        }
      }
    }
...
function onLoad_FLV_Player(strMultimediaFlvName) {
  if (
    ...
    if (
      strMultimediaFlvNameHRef != null &&
      typeof strMultimediaFlvNameHRef != undefined
    ) {
...
function requestCpHTML5Size(targetWnd, iframeid) {
  if (targetWnd && targetWnd.postMessage)
    targetWnd.postMessage(
      'getCpHTML5Size' + gMsgSeparator + ',id:' + iframeid,
      '*'
    );
}
...
function replyCpHTML5Size(targetWnd, msgData) {
  ...
  targetWnd.postMessage(
    'setCpHTML5Size' +
      ...
      obj.id +
      ',height:' +
      parseFloat(pc.style.height) +
      ',width:' +
      parseFloat(pc.style.width),
    '*'
  );
}
