...
describe('Lexicon E2E Editor List and Entry', () => {
  ...
  it('edit page has correct word count', async () => {
    expect(await editorPage.edit.entriesList.count()).toEqual(
      await editorPage.edit.getEntryCount()
    );
  ...
  it('word 1: edit page has correct definition, part of speech', async () => {
    ...
    expect<any>(await editorUtil.getFieldValues('Part of Speech')).toEqual([
      editorUtil.expandPartOfSpeech(
        constants.testEntry1.senses[0].partOfSpeech.value
      ),
    ]);
  });
  ...
  it('dictionary citation reflects lexeme form', async () => {
    ...
    expect(await editorPage.edit.renderedDiv.getText()).toContain(
      constants.testEntry1.lexeme['th-fonipa'].value
    );
    expect(await editorPage.edit.renderedDiv.getText()).not.toContain(
      'citation form'
    );
  });
  ...
  it('add citation form as visible field', async () => {
    ...
    await util.setCheckbox(
      configPage.unifiedPane.hiddenIfEmptyCheckbox('Citation Form'),
      false
    );
  ...
  it('citation form field overrides lexeme form in dictionary citation view', async () => {
    ...
    const citationFormMultiTextInputs =
      editorPage.edit.getMultiTextInputs('Citation Form');
    await editorPage.edit.selectElement.sendKeys(
      citationFormMultiTextInputs.first(),
      'citation form'
    );
    expect(await editorPage.edit.renderedDiv.getText()).toContain(
      'citation form'
    ...
    await editorPage.edit.selectElement.clear(
      citationFormMultiTextInputs.first()
    );
    expect(await editorPage.edit.renderedDiv.getText()).not.toContain(
      'citation form'
  ...
  it('one picture and caption is present', async () => {
    expect(await editorPage.edit.pictures.getFileName(0)).toContain(
      '_' + constants.testEntry1.senses[0].pictures[0].fileName
    );
    expect(await editorPage.edit.pictures.getCaption(0)).toEqual({
      en: constants.testEntry1.senses[0].pictures[0].caption.en.value,
    });
  });

  it('file upload drop box is displayed when Add Picture is clicked', async () => {
    expect<any>(await editorPage.edit.pictures.addPictureLink.isPresent()).toBe(
      true
    );
    expect<any>(await editorPage.edit.pictures.addDropBox.isDisplayed()).toBe(
      false
    );
    expect<any>(
      await editorPage.edit.pictures.addCancelButton.isDisplayed()
    ).toBe(false);
    ...
    expect<any>(
      await editorPage.edit.pictures.addPictureLink.isDisplayed()
    ).toBe(false);
    expect<any>(await editorPage.edit.pictures.addDropBox.isDisplayed()).toBe(
      true
    );
  ...
  it('change config to show Pictures and hide captions', async () => {
    ...
    await configPage.tabs.unified.click();
    await util.setCheckbox(
      configPage.unifiedPane.hiddenIfEmptyCheckbox('Pictures'),
      false
    );
    await configPage.unifiedPane.fieldSpecificButton('Pictures').click();
    await util.setCheckbox(
      configPage.unifiedPane.fieldSpecificCaptionHiddenIfEmptyCheckbox(
        'Pictures'
      ),
      true
    );
  ...
  it('caption is hidden when empty if "Hidden if empty" is set in config', async () => {
    ...
    await editorPage.edit.hideHiddenFields();
    expect<any>(
      await editorPage.edit.pictures.captions.first().isDisplayed()
    ).toBe(true);
    await editorPage.edit.selectElement.clear(
      editorPage.edit.pictures.captions.first()
    );
  ...
  it('picture is removed when Delete is clicked', async () => {
    expect<any>(await editorPage.edit.pictures.images.first().isPresent()).toBe(
      true
    );
    expect<any>(
      await editorPage.edit.pictures.removeImages.first().isPresent()
    ).toBe(true);
  ...
  it('audio Input System is present, playable and has "more" control (manager)', async () => {
    expect<any>(
      await editorPage.edit.audio.playerIcons(lexemeLabel).count()
    ).toEqual(1);
    expect<any>(
      await editorPage.edit.audio.playerIcons(lexemeLabel).first().isDisplayed()
    ).toBe(true);
    expect<any>(
      await editorPage.edit.audio
        .playerIcons(lexemeLabel)
        .first()
        .getAttribute('class')
    ).toContain('fa-play');
    expect<any>(
      await editorPage.edit.audio.players(lexemeLabel).first().isDisplayed()
    ).toBe(true);
    expect<any>(
      await editorPage.edit.audio.players(lexemeLabel).first().isEnabled()
    ).toBe(true);
    expect<any>(
      await editorPage.edit.audio
        .moreControls(lexemeLabel)
        .first()
        .isDisplayed()
    ).toBe(true);
    expect<any>(
      await editorPage.edit.audio.moreControls(lexemeLabel).first().isEnabled()
    ).toBe(true);
    expect<any>(
      await editorPage.edit.audio
        .uploadButtons(lexemeLabel)
        .first()
        .isDisplayed()
    ).toBe(false);
    expect<any>(
      await editorPage.edit.audio
        .downloadButtons(lexemeLabel)
        .first()
        .isDisplayed()
    ).toBe(false);
  });
  ...
  it('file upload drop box is displayed when Upload is clicked', async () => {
    ...
    expect<any>(
      await editorPage.edit.audio
        .uploadDropBoxes(lexemeLabel)
        .first()
        .isDisplayed()
    ).toBe(false);
    expect<any>(
      await editorPage.edit.audio
        .uploadCancelButtons(lexemeLabel)
        .first()
        .isDisplayed()
    ).toBe(false);
  ...
  it('click on second word (found by definition)', async () => {
    await editorPage.edit
      .findEntryByDefinition(constants.testEntry2.senses[0].definition.en.value)
      .click();
  });

  it('word 2: audio Input System is not playable but has "upload" button (manager)', async () => {
    expect<any>(
      await editorPage.edit.audio.playerIcons(lexemeLabel).first().isPresent()
    ).toBe(false);
    expect<any>(
      await editorPage.edit.audio.players(lexemeLabel).first().isPresent()
    ).toBe(false);
    expect<any>(
      await editorPage.edit.audio
        .moreControls(lexemeLabel)
    ...
    expect<any>(
      await editorPage.edit.audio.uploadButtons(lexemeLabel).first().isEnabled()
    ).toBe(true);
    expect<any>(
      await editorPage.edit.audio
        .downloadButtons(lexemeLabel)
  ...
  it('word 2: audio Input System is not playable and does not have "upload" button (observer)', async () => {
    expect<any>(
      await editorPage.edit.audio.playerIcons(lexemeLabel).first().isPresent()
    ).toBe(false);
    expect<any>(
  ...
  describe('Mock file upload', async () => {
    it("can't upload a non-audio file", async () => {
      ...
      await editorPage.edit.audio.uploadButtons(lexemeLabel).first().click();
      await editorPage.edit.audio
        .control(lexemeLabel, 0)
        .mockUpload.enableButton.click();
      expect(
        await editorPage.edit.audio
          .control(lexemeLabel, 0)
          .mockUpload.fileNameInput.isDisplayed()
      ).toBe(true);
      await editorPage.edit.audio
        .control(lexemeLabel, 0)
        .mockUpload.fileNameInput.sendKeys(
          constants.testMockPngUploadFile.name
        );
      await editorPage.edit.audio
        .control(lexemeLabel, 0)
        .mockUpload.fileSizeInput.sendKeys(
          constants.testMockPngUploadFile.size
        );
      await editorPage.edit.audio
        .control(lexemeLabel, 0)
        .mockUpload.uploadButton.click();
      expect<any>(await editorPage.noticeList.count()).toBe(1);
      expect<any>(await editorPage.noticeList.first().getText()).toContain(
        constants.testMockPngUploadFile.name +
      ...
      await editorPage.edit.audio
        .control(lexemeLabel, 0)
        .mockUpload.fileNameInput.clear();
      await editorPage.edit.audio
        .control(lexemeLabel, 0)
        .mockUpload.fileSizeInput.clear();
    ...
    it('can upload an audio file', async () => {
      ...
      await editorPage.edit.audio
        .control(lexemeLabel, 0)
        .mockUpload.fileNameInput.sendKeys(
          constants.testMockMp3UploadFile.name
        );
      await editorPage.edit.audio
        .control(lexemeLabel, 0)
        .mockUpload.fileSizeInput.sendKeys(
          constants.testMockMp3UploadFile.size
        );
      await editorPage.edit.audio
        .control(lexemeLabel, 0)
        .mockUpload.uploadButton.click();
  ...
  it('word 2: edit page has correct definition, part of speech', async () => {
    ...
    expect<any>(await editorUtil.getFieldValues('Part of Speech')).toEqual([
      editorUtil.expandPartOfSpeech(
        constants.testEntry2.senses[0].partOfSpeech.value
      ),
    ]);
  });
  ...
  it('setup: click on word with multiple definitions (found by lexeme)', async () => {
    await editorPage.edit.toListLink.click();
    await editorPage.browse.clickEntryByLexeme(
      constants.testMultipleMeaningEntry1.lexeme.th.value
    );
  ...
  it('dictionary citation reflects example sentences and translations', async () => {
    expect(await editorPage.edit.renderedDiv.getText()).toContain(
      constants.testMultipleMeaningEntry1.senses[0].examples[0].sentence.th
        .value
    );
    expect(await editorPage.edit.renderedDiv.getText()).toContain(
      constants.testMultipleMeaningEntry1.senses[0].examples[0].translation.en
        .value
    );
    expect(await editorPage.edit.renderedDiv.getText()).toContain(
      constants.testMultipleMeaningEntry1.senses[0].examples[1].sentence.th
        .value
    );
    expect(await editorPage.edit.renderedDiv.getText()).toContain(
      constants.testMultipleMeaningEntry1.senses[0].examples[1].translation.en
        .value
    );
    expect(await editorPage.edit.renderedDiv.getText()).toContain(
      constants.testMultipleMeaningEntry1.senses[1].examples[0].sentence.th
        .value
    );
    expect(await editorPage.edit.renderedDiv.getText()).toContain(
      constants.testMultipleMeaningEntry1.senses[1].examples[0].translation.en
        .value
    );
    expect(await editorPage.edit.renderedDiv.getText()).toContain(
      constants.testMultipleMeaningEntry1.senses[1].examples[1].sentence.th
        .value
    );
    expect(await editorPage.edit.renderedDiv.getText()).toContain(
      constants.testMultipleMeaningEntry1.senses[1].examples[1].translation.en
        .value
    );
  });

  it('word with multiple definitions: edit page has correct definitions, parts of speech', async () => {
    expect<any>(await editorUtil.getFieldValues('Definition')).toEqual([
    ...
    expect<any>(await editorUtil.getFieldValues('Part of Speech')).toEqual([
      editorUtil.expandPartOfSpeech(
        constants.testMultipleMeaningEntry1.senses[0].partOfSpeech.value
      ),
      editorUtil.expandPartOfSpeech(
        constants.testMultipleMeaningEntry1.senses[1].partOfSpeech.value
      ),
    ]);
  });
  ...
  it('word with multiple meanings: edit page has correct example sentences, translations', async () => {
    expect<any>(await editorUtil.getFieldValues('Sentence')).toEqual([
      {
        th: constants.testMultipleMeaningEntry1.senses[0].examples[0].sentence
          .th.value,
      },
      {
        th: constants.testMultipleMeaningEntry1.senses[0].examples[1].sentence
          .th.value,
      },
      {
        th: constants.testMultipleMeaningEntry1.senses[1].examples[0].sentence
          .th.value,
      },
      {
        th: constants.testMultipleMeaningEntry1.senses[1].examples[1].sentence
          .th.value,
      },
    ]);
    expect<any>(await editorUtil.getFieldValues('Translation')).toEqual([
      {
        en: constants.testMultipleMeaningEntry1.senses[0].examples[0]
          .translation.en.value,
      },
      {
        en: constants.testMultipleMeaningEntry1.senses[0].examples[1]
          .translation.en.value,
      },
      {
        en: constants.testMultipleMeaningEntry1.senses[1].examples[0]
          .translation.en.value,
      },
      {
        en: constants.testMultipleMeaningEntry1.senses[1].examples[1]
          .translation.en.value,
      },
    ]);
  });
  ...
  it('while Show Hidden Fields has not been clicked, hidden fields are hidden if they are empty', async () => {
    expect<any>(await editorPage.edit.getFields('Semantics Note').count()).toBe(
      0
    );
    expect<any>(
      await editorPage.edit.getOneField('General Note').isPresent()
    ).toBe(true);
    await editorPage.edit.showHiddenFields();
    expect<any>(
      await editorPage.edit.getOneField('Semantics Note').isPresent()
    ).toBe(true);
    expect<any>(
      await editorPage.edit.getOneField('General Note').isPresent()
    ).toBe(true);
  ...
  it('modify new word', async () => {
    ...
    await editorPage.edit
      .getMultiTextInputs(lexemeLabel)
      .first()
      .sendKeys(word);
    await editorPage.edit
  ...
  it('autosaves changes', async () => {
    await browser.refresh();
    await browser.wait(
      ExpectedConditions.visibilityOf(await editorPage.edit.fields.last())
    );
    await editorPage.edit
      .getMultiTextInputs(lexemeLabel)
      .first()
  ...
  it('new word is visible in edit page', async () => {
    await editorPage.edit.search.input.sendKeys(
  ...
  it('check that Semantic Domain field is visible (for view settings test later)', async () => {
    ...
    expect(
      await editorPage.edit.getOneField('Semantic Domain').isPresent()
    ).toBeTruthy();
  });
  ...
  describe('Configuration check', async () => {
    ...
    it('Word has only "th", "tipa" and "taud" visible', async () => {
      expect<any>(
        await editorPage.edit.getMultiTextInputSystems(lexemeLabel).count()
      ).toBeGreaterThanOrEqual(3);
      expect<any>(
        await editorPage.edit
          .getMultiTextInputSystems(lexemeLabel)
          .get(0)
          .getText()
      ).toEqual('th');
      expect<any>(
    ...
    it('make "en" input system visible for "Word" field', async () => {
      ...
      await util.setCheckbox(
        configPage.unifiedPane.entry.fieldSpecificInputSystemCheckbox(
          lexemeLabel,
          englishRowLabel
        ),
        true
    ...
    it('make "taud" input system invisible for "Word" field and "tipa" invisible for manager role', async () => {
      ...
      await util.setCheckbox(
        configPage.unifiedPane.managerCheckbox(ipaRowLabel),
        false
      );
  ...
  it('new word is visible in browse page', async () => {
    await editorPage.edit.toListLink.click();
    await editorPage.browse.search.input.sendKeys(
      constants.testEntry3.senses[0].definition.en.value
    );
    expect<any>(await editorPage.browse.search.getMatchCount()).toBe(1);
    await editorPage.browse.search.clearBtn.click();
  ...
  it('check that word count is still correct in browse page', async () => {
    expect(await editorPage.browse.entriesList.count()).toEqual(
  ...
  it('remove new word to restore original word count', async () => {
    ...
    await browser.wait(
      ExpectedConditions.visibilityOf(await editorPage.modal.modalBodyText)
    );
